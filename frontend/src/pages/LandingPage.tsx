        ...
        <>
          ...
          <section className="max-w-7xl mx-auto w-full flex flex-col gap-6 mt-6 border-t border-slate-200/80 pt-8 animate-fade-in-up">
            <div className="flex flex-col gap-1 border-b border-slate-200/60 pb-4">
              ...
              <p className="text-xs sm:text-sm text-slate-500 font-semibold">Đầy đủ đề thi ôn tập học kỳ và phòng thi trắc nghiệm chấm điểm tự động từ lớp 1 đến lớp 12.</p>
            </div>
            <MaterialsView />
          </section>
